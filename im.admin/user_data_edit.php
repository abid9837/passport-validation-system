...
if(isset($_GET['edit']) && $_GET['edit']==1){
    ...
    // 
    $user_show_sql = "SELECT * FROM `passposrt_users_info` WHERE id='$user_id'";
    $user_show_Query =  mysqli_query($conn, $user_show_sql);
    $user_show_Num_Rows = mysqli_num_rows($user_show_Query);
    $user_show_Fetch_assoc = mysqli_fetch_assoc($user_show_Query);
            ...
            <div id="content">
                ...
                <div  class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 id="jfgj" class="h3 mb-0 text-gray-800">Update User</h1>
                    </div>
                    ...
                    <section id="add_new_user_section_main_container">
                        ...
                        <div id="add_new_user_section_main_container_inner">
                            <form onsubmit="admin_user_UPDATE(<?php echo $user_id; ?>);">
                                <!-- user_name -->
                                <div class="mb-3">
                                    <label for="" class="form-label">Aplication Date</label>
                                    <input type="date" class="form-control" id="Aplication_Date" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['aplication_date']; ?>">
                                </div>

                                <!-- user_phone_number -->
                                <div class="mb-3">
                                    <label for="" class="form-label">Passport Number</label>
                                    <input type="text" class="form-control" id="Passport_Number" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['passport_number']; ?>">
                                </div>

                                <!-- user_email -->
                                <div class="mb-3">
                                    <label for="" class="form-label">Request Number</label>
                                    <input type="text" class="form-control" id="Request_Number" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['request_number']; ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="Country" id="user_country" class="form-control">
                                        <option value="<?php echo $user_show_Fetch_assoc['country']; ?>"><?php echo $user_show_Fetch_assoc['country']; ?></option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="Name_of_Owner" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['name_of_owner']; ?>">
                                </div>
                                
                                <!-- user_request_number -->
                                <div class="mb-3">
                                    <label for="" class="form-label">Consulate</label>
                                    <input type="text" class="form-control" id="Consulate" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['consulate']; ?>">
                                </div>

                                <!-- user_request_number -->
                                <div class="mb-3">
                                    <label for="" class="form-label">Days Stay (only number)</label>
                                    <input type="number" class="form-control" id="Days_Stay" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['days_stay']; ?>">
                                </div>

                                <!-- user_request_number -->
                                <div class="mb-3">
                                    <label for="" class="form-label">Type of Procedure</label>
                                    <input type="text" class="form-control" id="Type_of_Procedure" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['type_of_procedure']; ?>">
                                </div>
                                
                                <!-- user_request_number -->
                                <div class="mb-3">
                                    <label for="" class="form-label">Validity</label>
                                    <input type="text" class="form-control" id="Validity" aria-describedby="emailHelp" value="<?php echo $user_show_Fetch_assoc['validity']; ?>">
                                </div>
