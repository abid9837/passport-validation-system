...
$user_show_sql = "SELECT * FROM `passposrt_users_info` WHERE passport_number='$search' ";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Search Result (<span id="Total_count_edit_page"><?php echo $user_show_Num_Rows; ?></span>)</h1>
                    </div>
                    <!-- //////////////////////////////////////////////////////////// -->
                    <!-- php -->
                    <?php   
