        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section id="admin_profile_update_container">
                        <div id="admin_prifle_Info">
                            <div class="admin_profile_div">
                                <div>
                                    <img src="img/admin/<?php echo $fetch_assoc_ADMIN['imgs']; ?>" alt="">
                                </div>
                            </div>
                            <!--  -->
                            <div class="admin_name_div">
                                <p><?php echo $fetch_assoc_ADMIN['name']; ?></p>
                                <p style="font-size: 15px"><?php echo $fetch_assoc_ADMIN['email']; ?></p>
                                <a href="./admin.edit.profile.php" class="btn btn-info"  style="margin-top: 15px;"> Edit Admin Profile </a>
